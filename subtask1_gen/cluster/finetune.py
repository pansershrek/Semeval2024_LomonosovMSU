...
def main():
    ...
    parser.add_argument(
        "--config", default="/mnt/g.skiba/semeval2024/llama_2.json"
    )
    ...
    model = AutoModelForCausalLM.from_pretrained(
        ...
        #load_in_16bit = config["TRAIN_PARAMS"]["LOAD_IN_8BIT"],
    ...
    if config["MODEL_NAME"] == "TencentARC/LLaMA-Pro-8B":
        print("Create llama pro", flush=True)
